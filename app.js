...
const a = +prompt("(a) qiymatni kiriting:");
const b = +prompt(" (b) qiymatni kiriting:");
...
// let minutesInput = +prompt("(minut) qiymatni kiriting:");
...
// let numInput = +prompt("son kiriting:");
...
// } else {
//   console.log(" son kiritilgan. to'g'ri butun raqam kiriting.");
// }
...
// function ageToDays() {
//   let ageInYearsInput = prompt(" yoshingizni kiriting:");
...
//     );
//   } else {
//     console.log("Noto'g'ri ma'lumot kiritilgan. son kiriting.");
//   }
// }
...
// function cube(x) {
//   if (isNaN(x)) {
//     return "Noto'g'ri ma'lumot kiritilgan. son kiriting.";
//   } else {
//     return x * x * x;
//   }
// }
...
//   } else {
//     console.log("Noto'g'ri kiritilgan ma'lumot.son kiriting.");
//   }
// }
...
//   } else {
//     console.log("Noto'g'ri kiritilgan ma'lumot.soatni son sifatida kiriting.");
//   }
// }
...
//   } else {
//     console.log("Noto'g'ri kiritilgan ma'lumot.tomon uzunliklarini son sifatida kiriting.");
//   }
// }
...
//     } else {
//       console.log("Noto'g'ri kiritilgan ma'lumot.daqiqalar va FPS ni son sifatida kiriting.");
//     }
//   }
...
// function calc() {
//     let expressionInput = prompt(" matematik ifodani kiriting: (masalan, 23+4):");
...
// function equal10() {
//     let num1Input = prompt("sonni kiriting:");
//     let num2Input = prompt("sonni kiriting:");
...
//       console.log(result);
//     } else {
//       console.log("Noto'g'ri kiritilgan ma'lumot.sonlarni kiriting.");
//     }
//   }
...
//     let distanceInput = prompt("masofani kiriting (km):");
...
//     } else {
//       console.log("Noto'g'ri kiritilgan ma'lumot. masofani son sifatida kiriting.");
//     }
//   }
...
// function divide() {
//     let num1Input = prompt("birinchi sonni kiriting (kichikroq yoki teng):");
//     let num2Input = prompt("ikkinchi sonni kiriting (kattaroq):");
...
// function number() {
//     let inputString = prompt("raqamni kiriting:");
...
//     } else {
//       console.log("Noto'g'ri kiritilgan ma'lumot. raqamni kiriting.");
//     }
//   }
...
//     let side2Input = prompt("to'g'ri to'rtburchakning ikkinchi tomonini kiriting:");
//     let side1Input = prompt("to'g'ri to'rtburchakning birinchi tomonini kiriting:");
...
//     let surnameInput = prompt("Familiyangizni kiriting:");
...
//     } else {
//       console.log("Noto'g'ri ma'lumot kiritilgan.musbat sonni kiriting.");
//     }
//   }
...
//     let upvotes = Number(prompt("Qo'llab-quvvatlash ovozlarini kiriting:"));
//     let downvotes = Number(prompt("Qarshi ovozlarini kiriting:"));
...
// function negative() {
//     let inputNumStr = prompt("raqam kiriting:");
...
//     } else {
//       console.log("qanday ma'lumot kiritilgan.  to'g'ri raqamni kiriting.");
//     }
//   }
